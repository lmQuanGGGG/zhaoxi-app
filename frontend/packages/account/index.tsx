  ...
  return <section style={{display:"grid",gap:14}}>
    ...
    {account&&<>
      ...
      <div style={{padding:16,border:"1px solid #e5e7eb",borderRadius:18,background:"#fff"}}>
        ...
        {account.organizations.map(o=><p key={o.id}>{o.name} · {o.memberRole}</p>)}
