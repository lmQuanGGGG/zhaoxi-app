...
export const I18N = {
  vi: {
    ...
    switchStoreSuccessTitle: "Đổi gian hàng thành công",
    switchStoreSuccessDesc: (name: string) => `Bạn đã chuyển qua gian hàng ${name}`,
    ...
    analyzingTitle: "ZhaoXi đang phân tích dữ liệu…",
    analyzingDesc: "Đang kết nối mô hình dữ liệu để tổng hợp doanh thu, tỷ lệ hoàn tất và xu hướng món theo thời gian thực.",
    selectDateRange: "Tùy chọn khoảng ngày phân tích",
    fromDate: "Từ ngày (YYYY-MM-DD)",
    toDate: "Đến ngày (YYYY-MM-DD)",
    apply: "Áp dụng phân tích",
    invalidDateRange: "Vui lòng nhập định dạng YYYY-MM-DD hợp lệ.",
    customRangeBadge: (from: string, to: string) => `${from} → ${to}`,
  },
  en: {
    // Navigation
    orders: "Orders",
    ...
    switchStoreSuccessTitle: "Store Switched Successfully",
    switchStoreSuccessDesc: (name: string) => `You have switched to store ${name}`,
    currentStore: "Active",
    ...
    analyzingTitle: "ZhaoXi is analyzing data…",
    analyzingDesc: "Connecting data models to calculate revenue, completion rates, and item sales trends in real time.",
    selectDateRange: "Select Analysis Date Range",
    fromDate: "From date (YYYY-MM-DD)",
    toDate: "To date (YYYY-MM-DD)",
    apply: "Apply Analysis",
    invalidDateRange: "Please enter valid dates in YYYY-MM-DD format.",
    customRangeBadge: (from: string, to: string) => `${from} → ${to}`,
  },
  zh: {
    // Navigation
    ...
    switchStoreSuccessTitle: "店铺切换成功",
    switchStoreSuccessDesc: (name: string) => `您已切换至店铺 ${name}`,
    currentStore: "当前选中",
    ...
    refreshAnalytics: "刷新",
    analyzingTitle: "赵喜正在分析经营数据…",
    analyzingDesc: "正在连接数据模型，实时计算营收、订单完成率与热销趋势。",
    selectDateRange: "自定义经营分析日期范围",
    fromDate: "起始日期 (YYYY-MM-DD)",
    toDate: "截止日期 (YYYY-MM-DD)",
    apply: "应用分析",
    invalidDateRange: "请输入有效的 YYYY-MM-DD 格式日期。",
    customRangeBadge: (from: string, to: string) => `${from} → ${to}`,
  },
};
