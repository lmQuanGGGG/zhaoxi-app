...
export default function CustomerOrderAlerts(){
  ...
  const foodLabel=note==="EXTERNAL_DELIVERY_DELIVERED"?arrivalCopy[locale]:note==="FOOD_HANDED_TO_COURIER"?t.handedOff:note==="EXTERNAL_COURIER_BOOKED"?t.courierBooked:note==="FOOD_READY_FOR_PICKUP"||note==="AUTO_READY_FOR_EXTERNAL_PICKUP"?t.foodReady:"";
