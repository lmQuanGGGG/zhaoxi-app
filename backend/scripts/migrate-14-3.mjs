...
try {
  const migration = await readFile(new URL("../migrations/0004_driver_delivery_core.sql", import.meta.url), "utf8");
  await sql.unsafe(migration);
  console.log("Sprint 14.3 driver and delivery core migration applied.");
